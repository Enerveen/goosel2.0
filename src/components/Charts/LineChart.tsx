import {CartesianGrid, Legend, Line, Tooltip, XAxis, YAxis, LineChart as RechartsLineChart, Brush, ResponsiveContainer} from "recharts";
...
const LineChart = ({data, dataKeys, xAxisDataKey}: ILineChartProps) =>
